...
const UserList = () => {
  ...
  console.log(
    `${import.meta.env.VITE_BACKEND_URL}/${editFormik.values.imageUrl}`
  );
  console.log(editFormik.values.imageUrl);
          ...
          <form onSubmit={createFormik.handleSubmit}>
            ...
            {createImagePreview && (
              <img
                ...
                alt="Profile Preview"
                className="mt-2 mb-2 h-32 w-32 object-cover"
              />
            )}
            {createFormik.errors.image && (
              <p className="text-red-600">{createFormik.errors.image}</p>
            )}
<div className="mt-2">
            <Label htmlFor="name" >
              Name
            ...
            {createFormik.touched.userType && createFormik.errors.userType && (
      ...
      <Modal
        theme={modalTheme}
        show={editModalOpen}
        onClose={() => {setEditModalOpen(false); setEditImagePreview(null);}}
        // popup
        size="md"
        position={"center"}
      >
